...
import os
from ripplechat.bounded_engine import bounded_llm
...
# ------------------------------------------------------------
# Initialize RippleChat session memory
# ------------------------------------------------------------
...
with tab_ripplechat:
    ...
    # ==========================================================
    # SINGLE RENDER LOOP — All assistant messages printed once
    # ==========================================================
    if "ripplechat_messages" not in st.session_state:
        st.session_state.ripplechat_messages = []

    # Unified chat history render
    ...
    if user_input:
        ...
        # ====================================================
        # BOUNDED RippleChat AI MODE — Local placeholder "Ripple LLM"
        # ====================================================
        
        # ------------------------------
        # BOUNDED MODE – Real Engine
        # ------------------------------
    from ripplechat.bounded_engine import bounded_llm

    if active_mode == "bounded":
        response = bounded_llm(user_input)
