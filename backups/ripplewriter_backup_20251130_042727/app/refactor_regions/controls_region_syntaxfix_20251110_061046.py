...
def render_controls_panel():
    ...
    commit_msg = st.sidebar.text_input("Commit message", key="commit_message_sidebar"), value="Publish via RippleWriter Studio")
    branch = st.sidebar.text_input("Branch", key="branch_sidebar"), value="main")
