...
def render_controls_panel():
    ...
    commit_msg = st.sidebar.text_input("Commit message", value="Publish via RippleWriter Studio", key="commit_message_sidebar")
    branch = st.sidebar.text_input("Branch", value="main", key="branch_sidebar")
